module ColoursHelper
  ...
  def colour_class_text(colour_str)
	...
	def get_contrast(colour_hex)
		...
		blue = colour_hex[-2..-1].to_i(16)
		# get mid range value ("FF" base 16 is 255)
		mid = (255 * 3) / 2
		# if it's less than mid then the contrast is light grey
		# else the contrast is dark grey
		red + green + blue < mid ? '#c0c0c0' : '#404040'
	end
